...
function RadioGroupItem({ className, ...props }: ComponentProps<typeof RadioGroupPrimitive.Item>) {
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        "border-input text-primary ui-focus-ring ui-invalid-ring dark:bg-input/30 aspect-square size-4 shrink-0 rounded-full border shadow-xs transition-[color,box-shadow] outline-none ui-disabled",
        className,
      )}
      {...props}
    >
