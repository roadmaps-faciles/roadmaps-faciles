...
ADD VALUE 'ORG_CREATE';
ALTER TYPE "AuditAction"
ADD VALUE 'ORG_UPDATE';
ALTER TYPE "AuditAction"
ADD VALUE 'ORG_DELETE';
ALTER TYPE "AuditAction"
ADD VALUE 'ORG_MEMBER_ADD';
ALTER TYPE "AuditAction"
ADD VALUE 'ORG_MEMBER_REMOVE';
ALTER TYPE "AuditAction"
ADD VALUE 'ORG_MEMBER_ROLE_UPDATE';
ALTER TYPE "AuditAction"
ADD VALUE 'ORG_DOMAIN_ADD';
ALTER TYPE "AuditAction"
ADD VALUE 'ORG_DOMAIN_REMOVE';
ALTER TYPE "AuditAction"
ADD VALUE 'ORG_DOMAIN_VERIFY';
ALTER TYPE "AuditAction"
ADD VALUE 'ORG_ADDON_TOGGLE';
-- CreateTable
...
SELECT COALESCE(ts."name", 'orphan-' || t."id"),
...
-- AddForeignKey
ALTER TABLE "Tenant"
ADD CONSTRAINT "Tenant_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "OrgMember"
ADD CONSTRAINT "OrgMember_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "OrgMember"
ADD CONSTRAINT "OrgMember_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "OrgDomain"
ADD CONSTRAINT "OrgDomain_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "OrgAddon"
ADD CONSTRAINT "OrgAddon_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "OrgAddon"
ADD CONSTRAINT "OrgAddon_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE
